...
export default function Login({ setAuthPage, onLoginSuccess }) {
  ...
  return (
    // Tambahkan div pembungkus (container) di sini untuk memusatkan UI
...
const containerStyle = { 
  ...
  alignItems: 'center', 
  minHeight: '100vh', 
  backgroundColor: '#f8f9fa', // Warna latar belakang opsional agar card lebih menonjol
  padding: '20px' // Memberi jarak agar tidak menempel di tepi layar saat di HP
};

// Menghapus 'position: center' yang tidak valid
const cardStyle = { 
  width: '100%', 
  maxWidth: '420px', 
  background: '#ffffff', 
